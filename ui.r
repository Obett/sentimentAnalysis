...
shinyUI(fluidPage(
  ...
  mainPanel( 
    tabsetPanel(type = "tabs",
                ...
                ,
                tabPanel("Doc_Term_Matrix",
                         verbatimTextOutput("Doc_Term_Matrixsize"),
                         h4("Sample Doc_Term_Matrix (Document Term Matrix) "),
                         DT::dataTableOutput("Doc_Term_Matrix_table"),br(), 
                         h4("Word Cloud"),
                         plotOutput("wordcloud",height = 700, width = 700),br(),
                         #textInput("in",label = "text"),
                         h4("Wordcloud Weights Distribution"),
                         DT::dataTableOutput("Doc_Term_Matrix_summary1")),
                
                tabPanel("Term_Freq-Inverse_Doc_ Freq", 
                         verbatimTextOutput("idf_size"),
                         h4("Sample Term_Freq-Inverse_Doc_ Freq (Term Frequency-Inverse Document Frequency) "),
                         DT::dataTableOutput("idf_table"),br(), 
                         h4("Word Cloud"),
                         plotOutput("idf_wordcloud",height = 700, width = 700),br(),
                         #textInput("in",label = "text"),
                         h4("Wordcloud Weights Distribution"),
                         DT::dataTableOutput("Doc_Term_Matrixsummary2")),
                tabPanel("Co-occurrence Term",
                         h4("Doc_Term_Matrix Co-occurrence"),
                         visNetworkOutput("cog.Doc_Term_Matrix",height = 700, width = 700),
                         h4("Term_Freq-Inverse_Doc_ Freq Co-occurrence"),
                ...
                tabPanel("Downloads",
                         h4("Download Doc_Term_Matrix"),
                         #h3("-------------"),
                         verbatimTextOutput("Doc_Term_Matrix_text"),
                         downloadButton('download_Doc_Term_Matrix', 'Download Doc_Term_Matrix'),br(),
                        
                         
                         h3("-----------------------------------------------------"),
                         h4("Download Term_Freq-Inverse_Doc_ Freq"),
                         verbatimTextOutput("tfidf_text"),
                         downloadButton('download_tfidf', 'Download Term_Freq-Inverse_Doc_ Freq'),br(),

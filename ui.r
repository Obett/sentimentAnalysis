  ...
  mainPanel( 
    tabsetPanel(type = "tabs",
                ...
                tabPanel("Document Term Matrix",
                         verbatimTextOutput("Document Term Matrixsize"),
                         h4("Sample Document Term Matrix (Document Term Matrix) "),
                         DT::dataTableOutput("Document Term Matrix_table"),br(), 
                         h4("Word Cloud"),
                         plotOutput("wordcloud",height = 700, width = 700),br(),
                         #textInput("in",label = "text"),
                         h4("Wordcloud Weights Distribution"),
                         DT::dataTableOutput("Document Term Matrix_summary1")),
                
                tabPanel("Term Frequency-Inverse Document Frequency", 
                         verbatimTextOutput("idf_size"),
                         h4("Sample Term Frequency-Inverse Document Frequency (Term Frequency-Inverse Document Frequency) "),
                         DT::dataTableOutput("idf_table"),br(), 
                         h4("Word Cloud"),
                         plotOutput("idf_wordcloud",height = 700, width = 700),br(),
                         #textInput("in",label = "text"),
                         h4("Wordcloud Weights Distribution"),
                         DT::dataTableOutput("Document Term Matrixsummary2")),
                tabPanel("Co-occurrence Term",
                         h4("Document Term Matrix Co-occurrence"),
                         visNetworkOutput("cog.Document Term Matrix",height = 700, width = 700),
                         h4("Term Frequency-Inverse Document Frequency Co-occurrence"),
                ...
                tabPanel("Downloads",
                         h4("Download Document Term Matrix"),
                         #h3("-------------"),
                         verbatimTextOutput("Document Term Matrix_text"),
                         downloadButton('download_Document Term Matrix', 'Download Document Term Matrix'),br(),
                        
                         
                         h3("-----------------------------------------------------"),
                         h4("Download Term Frequency-Inverse Document Frequency"),
                         verbatimTextOutput("tfidf_text"),
                         downloadButton('download_tfidf', 'Download Term Frequency-Inverse Document Frequency'),br(),
